...
if(mysqli_connect_error()){
	...
	sno='',rep_bid='$rep_bid',rep_date='$rep_date',rep_loc='$rep_loc',rep_desc='$rep_desc' where rep_id='$rep_id';";
	
	
	if($conn-> query($sql)){
		echo $rep_loc."'s report updated";
	}
	else{
...
echo"</div> <a href='updateREPORT.html' class='btn btn-primary button' style='margin-left: 25%; margin-top: 1%'>Home</a>";
